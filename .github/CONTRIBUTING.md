# Contributing to rtadfr

This outlines how to propose a change to rtadfr. For more detailed
...
make sure someone from the team agrees that itג€™s a problem. If youג€™ve found a
